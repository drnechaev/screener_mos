...
from screener.datasets.mood_abdomen import MOODAbdomenTrain
...
@hydra.main(version_base=None, config_path='../configs', config_name='train_dense_vicreg_on_mood_abdomen')
