...
def main(config: DictConfig):
    ...
    print("Import weights of model...")
    model.load_state_dict(torch.load('/home/jovyan/dumerenkov/__screener/screener-main/models/glow_model.pt'))
    
    # trainer = pl.Trainer(
    #     accelerator='gpu',
    #     precision='16-mixed',
    #     logger=TensorBoardLogger(
    #         save_dir='/home/jovyan/dumerenkov/__screener/screener-main/models/',
    #         name=None,
    #         version='',
    #         log_graph=False
    #     ),
    ...
    #         dirpath='/home/jovyan/dumerenkov/__screener/screener-main/models/',
    #         filename='profile',
    #     ),
    ...
    # torch.save(model, '/home/jovyan/dumerenkov/__screener/screener-main/models/glow_model.pt')
